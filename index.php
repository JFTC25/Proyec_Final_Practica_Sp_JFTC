            ...
            if (isset($_GET['estado'])) {
              ...
              if ($estado == 1) {  ?>
                <div class="alert alert-success form-group" role="alert">
                  <span class="fe fe-check-circle fe-16 mr-2"></span>Se Registro Correctamente
                </div>
              <?php
              }
              if ($estado == 2) {  ?>
                <div class="alert alert-danger form-group" role="alert">
                  <span class="fe fe-x-circle fe-16 mr-2"></span> Usuario o Contraseña Incorrectos
                </div>
              <?php
              }
              if ($estado == 3) {  ?>
                <div class="alert alert-warning form-group" role="alert">
                  <span class="fe fe-alert-triangle fe-16 mr-2"></span> Debe Iniciar Sesion
                </div>
              <?php
              }
              if ($estado == 4) {  ?>
                <div class="alert alert-success form-group" role="alert">
                  <span class="fe fe-check-circle fe-16 mr-2"></span>Cerro Sesion Correctamente
                </div>
              <?php
              }
              if ($estado == 5) {  ?>
                <div class="alert alert-warning form-group" role="alert">
                  <span class="fe fe-tool fe-16 mr-2"></span>Se cambio correctamente la Contraseña
                </div>
            <?php
              }
            }
